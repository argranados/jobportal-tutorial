...
public class UsersService {
    ...
    public Object getCurrentUserProfile() {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            Users users = usersRepository.findByEmail(username).orElseThrow(()->new UsernameNotFoundException("Could not" +
                    " found user"));
    ...
    public Users getCurrentUser() {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            Users user = usersRepository.findByEmail(username).orElseThrow(()->new UsernameNotFoundException("Could not" +
                " found user"));
